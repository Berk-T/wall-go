                ...
                <li>
                  ...
                  <ul>
                    <li>
                      ...
                      <ul>
                        <li>Pucks cannot move through walls or other pucks.</li>
                        <li>You may end on the same tile you started.</li>
                      </ul>
                    </li>
                    <li>
                      <strong>Place a wall</strong> in an <strong>empty</strong>{" "}
                      wall slot adjacent to the tile your puck landed on.
                      <ul>
                        <li>
